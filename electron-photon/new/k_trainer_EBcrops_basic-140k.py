...
parser.add_argument('--train_size', default=140000, type=int, help='Training size per decay.')
...
parser.add_argument('--batch_size', default=1400, type=int, help='Batch size for gradient update during training.')
...
valid_start, valid_stop = 140000, 140000+args.valid_size
assert valid_stop  >  valid_start
assert valid_start >= train_stop
X_valid, y_valid = load_data(decays,valid_start,valid_stop)

# Set range of test set
test_start, test_stop = 184800, 184800+args.test_size
